...
struct CarImplementation aixam1 = { aixam, RED, false};
struct CarImplementation fiat_multipla1 = { fiat_multipla, GREEN, false};
struct CarImplementation fiat_multipla2 = { fiat_multipla, BLUE, false};
struct CarImplementation fiat_multipla3 = { fiat_multipla, ORANGE, false};
struct CarImplementation jeep1 = { jeep, SILVER, false};
struct CarImplementation jeep2 = { jeep, BLACK, false};
...
void accelerate(Car car) {
  double speed = car->car_data.acceleration_rate * 3.6;
  if (car->car_data.speed + speed < car->car_data.max_speed) {
